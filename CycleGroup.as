package
{
	...
	public class CycleGroup extends MovieClip
	{
		...
		public function initialize(e:Event) {
			...
			var krebCycle:MovieClip = new Cycle(krebCycleLabels, true, MyFunctions.genColor(0));
			...
			for(var i = 0; i < 8; i++) {
				var arginineCycle:MovieClip = new Cycle(arginineCycleLabels, true, MyFunctions.genColor(i+1));
			...
			var calvinCycle:MovieClip = new Cycle(calvinCycleLabels, false, MyFunctions.genColor(9));
